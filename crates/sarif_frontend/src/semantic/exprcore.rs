...
"bytes_byte_i64" => Some(BuiltinEntry {
    name: "bytes_byte_i64",
    runtime_code: None,
    arity_error_code: "semantic.bytes_byte_i64-arity",
    type_error_code: "semantic.bytes_byte_i64-type",
    result_ty: Type::I32,
    call_hint: "Call `bytes_byte_i64(bytes, offset)`.",
    arg_types: &[Type::Bytes, Type::I64],
    arg_helps: &["Pass a Bytes argument.", "Pass an I64 offset."],
    dispatch_simple: true,
}),
        "bytes_load_i32" => Some(BuiltinEntry {
            name: "bytes_load_i32",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_i32-arity",
            type_error_code: "semantic.bytes_load_i32-type",
            result_ty: Type::I32,
            call_hint: "Call `bytes_load_i32(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I32],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset."],
            dispatch_simple: true,
        }),
        "bytes_store_i32" => Some(BuiltinEntry {
            name: "bytes_store_i32",
            runtime_code: None,
            arity_error_code: "semantic.bytes_store_i32-arity",
            type_error_code: "semantic.bytes_store_i32-type",
            result_ty: Type::Unit,
            call_hint: "Call `bytes_store_i32(bytes, offset, value)`.",
            arg_types: &[Type::Bytes, Type::I32, Type::I32],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset.", "Pass an I32 value."],
            dispatch_simple: true,
        }),
        "bytes_load_i64" => Some(BuiltinEntry {
            name: "bytes_load_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_i64-arity",
            type_error_code: "semantic.bytes_load_i64-type",
            result_ty: Type::I64,
            call_hint: "Call `bytes_load_i64(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I32],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset."],
            dispatch_simple: true,
        }),
        "bytes_store_i64" => Some(BuiltinEntry {
            name: "bytes_store_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_store_i64-arity",
            type_error_code: "semantic.bytes_store_i64-type",
            result_ty: Type::Unit,
            call_hint: "Call `bytes_store_i64(bytes, offset, value)`.",
            arg_types: &[Type::Bytes, Type::I32, Type::I64],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset.", "Pass an I64 value."],
            dispatch_simple: true,
        }),
        "bytes_load_i32_i64" => Some(BuiltinEntry {
            name: "bytes_load_i32_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_i32_i64-arity",
            type_error_code: "semantic.bytes_load_i32_i64-type",
            result_ty: Type::I32,
            call_hint: "Call `bytes_load_i32_i64(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I64],
            arg_helps: &["Pass a Bytes argument.", "Pass an I64 offset."],
            dispatch_simple: true,
        }),
        "bytes_load_i64_i64" => Some(BuiltinEntry {
            name: "bytes_load_i64_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_i64_i64-arity",
            type_error_code: "semantic.bytes_load_i64_i64-type",
            result_ty: Type::I64,
            call_hint: "Call `bytes_load_i64_i64(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I64],
            arg_helps: &["Pass a Bytes argument.", "Pass an I64 offset."],
            dispatch_simple: true,
        }),
        "bytes_load_f32_i64" => Some(BuiltinEntry {
            name: "bytes_load_f32_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_f32_i64-arity",
            type_error_code: "semantic.bytes_load_f32_i64-type",
            result_ty: Type::F64,
            call_hint: "Call `bytes_load_f32_i64(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I64],
            arg_helps: &["Pass a Bytes argument.", "Pass an I64 offset."],
            dispatch_simple: true,
        }),
        "bytes_load_f64" => Some(BuiltinEntry {
            name: "bytes_load_f64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_f64-arity",
            type_error_code: "semantic.bytes_load_f64-type",
            result_ty: Type::F64,
            call_hint: "Call `bytes_load_f64(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I32],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset."],
            dispatch_simple: true,
        }),
        "bytes_store_f64" => Some(BuiltinEntry {
            name: "bytes_store_f64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_store_f64-arity",
            type_error_code: "semantic.bytes_store_f64-type",
            result_ty: Type::Unit,
            call_hint: "Call `bytes_store_f64(bytes, offset, value)`.",
            arg_types: &[Type::Bytes, Type::I32, Type::F64],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset.", "Pass an F64 value."],
            dispatch_simple: true,
        }),
        "bytes_load_bool" => Some(BuiltinEntry {
            name: "bytes_load_bool",
            runtime_code: None,
            arity_error_code: "semantic.bytes_load_bool-arity",
            type_error_code: "semantic.bytes_load_bool-type",
            result_ty: Type::Bool,
            call_hint: "Call `bytes_load_bool(bytes, offset)`.",
            arg_types: &[Type::Bytes, Type::I32],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset."],
            dispatch_simple: true,
        }),
        "bytes_store_bool" => Some(BuiltinEntry {
            name: "bytes_store_bool",
            runtime_code: None,
            arity_error_code: "semantic.bytes_store_bool-arity",
            type_error_code: "semantic.bytes_store_bool-type",
            result_ty: Type::Unit,
            call_hint: "Call `bytes_store_bool(bytes, offset, value)`.",
            arg_types: &[Type::Bytes, Type::I32, Type::Bool],
            arg_helps: &["Pass a Bytes argument.", "Pass an I32 offset.", "Pass a Bool value."],
            dispatch_simple: true,
        }),
        ...
        "bytes_slice_i64" => Some(BuiltinEntry {
            name: "bytes_slice_i64",
            runtime_code: None,
            arity_error_code: "semantic.bytes_slice_i64-arity",
            type_error_code: "semantic.bytes_slice_i64-type",
            result_ty: Type::Bytes,
            call_hint: "Call `bytes_slice_i64(bytes, start, length)`.",
            arg_types: &[Type::Bytes, Type::I64, Type::I64],
            arg_helps: &[
                "Pass a Bytes argument.",
                "Pass an I64 start offset.",
                "Pass an I64 length.",
            ],
            dispatch_simple: true,
        }),
        ...
        "text_to_bytes" => Some(BuiltinEntry {
            name: "text_to_bytes",
            runtime_code: None,
            arity_error_code: "semantic.text_to_bytes-arity",
            type_error_code: "semantic.text_to_bytes-type",
            result_ty: Type::Bytes,
            call_hint: "Call `text_to_bytes(text)` with exactly one Text argument.",
            arg_types: &[Type::Text],
        ...
        "f64_from_i64" => Some(BuiltinEntry {
            name: "f64_from_i64",
            runtime_code: None,
            arity_error_code: "semantic.f64_from_i64-arity",
            type_error_code: "semantic.f64_from_i64-type",
            result_ty: Type::F64,
            call_hint: "Call `f64_from_i64(value)` with one I64 argument.",
            arg_types: &[Type::I64],
            arg_helps: &["Pass an I64 value."],
            dispatch_simple: true,
        }),
