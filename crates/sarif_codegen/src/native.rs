...
#[derive(Clone)]
pub struct RuntimeHelperIds {
    pub allocator_id: FuncId,
    pub alloc_push_id: FuncId,
    pub alloc_pop_id: FuncId,
    pub text_builder_new_id: Option<FuncId>,
    pub text_builder_append_id: Option<FuncId>,
    pub text_builder_append_codepoint_id: Option<FuncId>,
    ...
    pub bytes_slice_id: FuncId,
    pub bytes_len_id: FuncId,
    pub bytes_byte_id: FuncId,
    pub bytes_materialize_id: FuncId,
    pub text_eq_range_id: FuncId,
    pub text_find_byte_range_id: FuncId,
    pub text_line_end_id: FuncId,
    pub text_next_line_id: FuncId,
    pub text_field_end_id: FuncId,
    pub text_next_field_id: FuncId,
    pub text_from_f64_fixed_id: FuncId,
    pub parse_i32_id: FuncId,
    pub parse_i32_range_id: FuncId,
    pub parse_f64_id: FuncId,
    pub arg_count_id: FuncId,
    pub arg_text_id: FuncId,
    pub stdin_text_id: FuncId,
    pub stdout_write_id: FuncId,
    pub file_open_id: FuncId,
    pub file_close_id: FuncId,
    pub file_read_id: FuncId,
    pub file_read_to_end_id: FuncId,
    pub file_mmap_id: FuncId,
    pub file_write_id: FuncId,
    pub file_seek_id: FuncId,
    pub file_size_id: FuncId,
...
pub fn declare_runtime_helpers<M: Module>(
    ...
    Ok(RuntimeHelperIds {
        ...
        text_index_helpers: TextIndexHelperIds {
            new_id: Some(declare_text_index_new(module, backend)?),
            get_id: Some(declare_text_index_get(module, backend)?),
            contains_id: Some(declare_text_index_contains(module, backend)?),
            get_or_insert_id: Some(declare_text_index_get_or_insert(module, backend)?),
            set_id: Some(declare_text_index_set(module, backend)?),
        ...
        bytes_slice_id: declare_bytes_slice(module, backend)?,
        bytes_len_id: declare_bytes_len(module, backend)?,
        bytes_byte_id: declare_bytes_byte(module, backend)?,
        bytes_materialize_id: declare_bytes_materialize(module, backend)?,
        text_eq_range_id: declare_text_eq_range(module, backend)?,
        text_find_byte_range_id: declare_text_find_byte_range(module, backend)?,
        text_line_end_id: declare_text_line_end(module, backend)?,
        text_next_line_id: declare_text_next_line(module, backend)?,
        text_field_end_id: declare_text_field_end(module, backend)?,
        text_next_field_id: declare_text_next_field(module, backend)?,
        text_from_f64_fixed_id: declare_text_from_f64_fixed(module, backend)?,
        parse_i32_id: declare_parse_i32(module, backend)?,
        parse_i32_range_id: declare_parse_i32_range(module, backend)?,
        parse_f64_id: declare_parse_f64(module, backend)?,
        arg_count_id: declare_arg_count(module, backend)?,
        arg_text_id: declare_arg_text(module, backend)?,
        stdin_text_id: declare_stdin_text(module, backend)?,
        stdout_write_id: declare_stdout_write(module, backend)?,
        file_open_id: declare_file_open(module, backend)?,
        file_close_id: declare_file_close(module, backend)?,
        file_read_id: declare_file_read(module, backend)?,
        file_read_to_end_id: declare_file_read_to_end(module, backend)?,
        file_mmap_id: declare_file_mmap(module, backend)?,
        file_write_id: declare_file_write(module, backend)?,
        file_seek_id: declare_file_seek(module, backend)?,
        file_size_id: declare_file_size(module, backend)?,
    ...
    match inst {
        ...
        Inst::EnumToI32 {
            ...
            let native = if discriminants.len() == 1 {
                ...
                result.unwrap_or_else(|| builder.ins().iconst(types::I32, 0))
            };
            values.insert(*dest, NativeValueRepr::Native(native));
            Ok(true)
        }
